...
<main>
	...
	<label for='formID'>Component ID: </label><input id='formID' bind:value={name} placeholder='eg: 02_wp_up_30'>

	<label for='formID'>List JSON: </label>
	<textarea value={jsonText} rows='20' class='jsonTextArea' on:change={jsonOnChange} ></textarea>
