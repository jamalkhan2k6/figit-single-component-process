...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Figit Single Component Editor";
    			t1 = space();
    			label0 = element("label");
    			label0.textContent = "Component ID: ";
    			input = element("input");
    			t3 = space();
    			label1 = element("label");
    			label1.textContent = "List JSON:";
    			t5 = space();
    			textarea = element("textarea");
    			t6 = space();
    			button0 = element("button");
    			button0.textContent = "Add Images";
    			t8 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(textarea, "change", /*jsonOnChange*/ ctx[2], false, false, false),
    					listen_dev(button0, "click", /*jsonTriggerChange*/ ctx[3], false, false, false),
    					listen_dev(button1, "click", /*downloadJson*/ ctx[4], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function jsonTriggerChange() {
    		...
    		$$invalidate(1, jsonText = jsonText.trim().replace(/^\[([\s\S]*)]$/, "$1"));
